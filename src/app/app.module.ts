...
import { MultiStepperVModule, MultiStepperModule, CardGridModule, HeaderModule,
  FooterModule, BreadcrumbModule, ScrollProgressModule, SideNavModule } from 'workshop';
